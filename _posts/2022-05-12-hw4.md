...
In the embedding visualization,we can find most of words that are adjacent to each other have relation.
 1. In the 2-dimensional embedding visualization, word **childrens** is closer to word like **school** .
 2. In the 2-dimensional embedding visualization, word **rubio** is closer to word like **candidate**.
 3. In the 2-dimensional embedding visualization, word **conference** is closer to word like **law**.
 4. In the 3-dimensional embedding visualization, word **lybia** is closer to word like **moscow**.
 5. In the 3-dimensional embedding visualization, word **supreme** is closer to word like **officer**.